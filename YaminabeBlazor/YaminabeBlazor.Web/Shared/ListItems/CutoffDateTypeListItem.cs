...
{
    /// <summary>
    /// 締日区分マスタのリスト選択モデルを提供します。
    /// </summary>
    /// <seealso cref="YaminabeBlazor.Web.Shared.Models.CutoffDateTypeModel" />
    ...
    public class CutoffDateTypeListItem : CutoffDateTypeModel, IListItemModel
    {
        ...
        /// キー値を取得または設定します。
        /// </summary>
        public string Key => ((int)this.CutoffDateType).ToString();

        /// <summary>
        /// 表示値を取得または設定します。
        /// </summary>
        public string Value => this.CutoffDateTypeName;
