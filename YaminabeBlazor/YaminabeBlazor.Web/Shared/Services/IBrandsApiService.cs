...
namespace YaminabeBlazor.Web.Shared.Services
{
    ...
    /// </revisionHistory>
    public interface IBrandsApiService
    {
        #region -------------------- method --------------------
        ...
        /// ブランドマスタリストを返却します。
        /// </returns>
        Task<(HttpStatusCode HttpStatusCode, List<BrandInputModel> Brands)> Get();

        /// <summary>
        /// ブランドマスタリストを更新します。
        /// </summary>
        /// <param name="addedItems">ブランドマスタリストの追加対象。</param>
        /// <param name="changedItems">ブランドマスタリストの更新対象。</param>
        /// <param name="deletedItems">ブランドマスタリストの削除対象。</param>
