...
namespace YaminabeBlazor.Core.Queries
{
    /// <summary>
    /// 商品マスタメンテナンスリストの取得クエリを表します。
    /// </summary>
    /// <seealso cref="YaminabeBlazor.Core.Repositories.IRepositoryBase" />
    /// <revisionHistory>
    ///     <revision date="2020/09/21" version="0.0.1-alfa" author="kzlabo">新規作成。</revision>
    /// </revisionHistory>
    public interface IProductsMaintenanceGetQuery : IRepositoryBase
    {
        #region -------------------- method --------------------
        ...
        /// </returns>
        List<IProductMaintenanceQueryModel> Get();
