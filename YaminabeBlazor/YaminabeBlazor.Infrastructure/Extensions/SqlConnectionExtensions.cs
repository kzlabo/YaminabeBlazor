...
namespace YaminabeBlazor.Infrastructure.Extensions
{
    ...
    ///     <revision date="2020/09/21" version="1.1.0.0" author="kzlabo">BulkCopyAttributeをDapperMapAttributeに統合。</revision>
    /// </revisionHistory>
    public static class SqlConnectionExtensions
    {
            ...
            )
        {
            ...
            {
                var attribute = Attribute.GetCustomAttribute(property, typeof(DapperMapAttribute)) as DapperMapAttribute;
                // 属性指定されていない場合は対象
                if (attribute == null)
                {
                    return true;
