...
namespace YaminabeBlazor.Component
{
    ...
    /// <seealso cref="YaminabeBlazor.Component.EditableControlComponentBase{TValue}" />
    /// <revisionHistory>
    ///     <revision date="2020/09/21" version="0.0.1-alfa" author="kzlabo">新規作成。</revision>
    /// </revisionHistory>
    public class EditableDateControlComponent<TValue> : EditableControlComponentBase<TValue>
    {
        #region -------------------- property --------------------
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            if (this.Item.EditMode == EditModeOptions.Edit)
            {
                    ...
                    (this.Item.EditState & this.EditableState) > 0)
                {
                    ...
                    builder.AddAttribute(3, "value", BindConverter.FormatValue(this.CurrentValue as DateTime?, "yyyy-MM-dd"));
