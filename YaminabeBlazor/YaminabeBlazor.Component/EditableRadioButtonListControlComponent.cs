...
namespace YaminabeBlazor.Component
{
    ...
    /// <typeparam name="TRadioModel">ラジオボタンリストの型。</typeparam>
    /// <seealso cref="YaminabeBlazor.Component.EditableSelectControlComponentBase{TValue, TDropModel}" />
    /// <revisionHistory>
    ///     <revision date="2020/09/21" version="0.0.1-alfa" author="kzlabo">新規作成。</revision>
    /// </revisionHistory>
    public class EditableRadioButtonListControlComponent<TValue, TRadioModel> : EditableSelectControlComponentBase<TValue, TRadioModel>
