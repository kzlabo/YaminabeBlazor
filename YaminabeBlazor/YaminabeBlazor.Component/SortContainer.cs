...
namespace YaminabeBlazor.Component
{
    ...
    /// </revisionHistory>
    public class SortContainer : ComponentBase
    {
        #region -------------------- property --------------------
        ...
        /// </summary>
        [Parameter]
        public SortContext Context { get; set; }
        ...
        {
            builder.OpenComponent<CascadingValue<SortContext>>(0);
            builder.AddAttribute(1, "Value", this.Context);
            builder.AddAttribute(2, "Name", "CascadeSortContext");
